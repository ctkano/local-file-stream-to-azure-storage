...
Files extracted from a variety of sources (such as from data base), files generated by a solution or files uploaded in a web application and stored in a local diretory, can be uploaded to Azure Storage dinamically and automated, by referencing this class library in an automate project.
